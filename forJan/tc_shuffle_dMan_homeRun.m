...
% get FMEVNTS struct!!
% put code for this here

% get homeRun struct (make sure this function is on path)
[homeRun] = getHomeRuns(position_trial, ST_trial, hd_trial, ref_point, fmEvents);
...
% t/x/y for homerun events (don't think i actually need this)
